...
def register():
    try:
        ...
        if request.method == 'POST':    
            ...
            number = hex(random.getrandbits(512))[2:]  #es este el mismo number que hay arriba?
...
def confirm():
    try:
        ...
        return render_template('auth/forgot.html')  # VERIFICAR 
    except:
        return render_template('auth/forgot.html')
...
def change():
    try:
        ...
        return render_template('auth/forgot.html') # --> verificar la redirección
